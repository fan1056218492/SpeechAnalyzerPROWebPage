const STORAGE_KEY = "offlinescribe.locale";
const LEGACY_STORAGE_KEY = "speechanalyzerpro.locale";
...
const baseTranslation = {
  meta: {
    title: "OfflineScribe - Private audio and video transcription for Mac",
    description: "OfflineScribe turns audio and video into editable text, documents, and bilingual subtitles locally on your Mac."
  },
  skip: "Skip to content",
  language: { label: "Language" },
  nav: { features: "Features", privacy: "Privacy", pricing: "Pricing", support: "Support" },
  hero: {
    eyebrow: "Private transcription for macOS",
    lead: "Transcribe audio and video, listen back while editing, and export documents or bilingual subtitles. Your media and text stay on your Mac.",
  ...
  features: {
    ...
    text: "OfflineScribe keeps the complete transcription workflow on your Mac: queue audio or video, pause long runs, review the synchronized timeline, then export in the format your next tool needs.",
  ...
  workflow: {
    ...
    text: "OfflineScribe keeps the queue, language selection, output folder, synchronized timeline, and export controls in one focused macOS workspace.",
    step1Label: "Add media",
    step1Text: "Drag audio or MP4/MOV video into the queue, or send supported files from Finder.",
  ...
  privacy: {
    ...
    appText: "OfflineScribe does not upload your audio, transcript text, or translations. The app is designed around Apple SpeechAnalyzer and Apple Translation frameworks running on your Mac.",
    ...
    storeText: "OfflineScribe is a paid App Store download. Every feature is included, with no in-app purchases, subscriptions, trials, purchase restoration, or feature unlocking inside the app.",
  ...
  pricing: {
    ...
    availableText: "Get OfflineScribe for macOS 26 or later."
  },
  support: {
    eyebrow: "Support",
  ...
  footer: {
    copy: "OfflineScribe. Private transcription, review, translation, and export for Mac.",
    back: "Back to top"
  }
};
...
const translations = {
  en: baseTranslation,
  de: {
    meta: { title: "OfflineScribe - Lokale Sprachtranskription fuer macOS", description: "OfflineScribe transkribiert Audio, prueft Zeitachsen, uebersetzt Text und exportiert Ergebnisse lokal auf macOS." },
    ...
    footer: { copy: "OfflineScribe. Lokale Transkription und uebersetzter Export fuer macOS.", back: "Nach oben" }
  },
  es: {
    meta: { title: "OfflineScribe - Transcripcion local para macOS", description: "OfflineScribe transcribe audio, revisa lineas de tiempo, traduce texto y exporta resultados localmente en macOS." },
    ...
    footer: { copy: "OfflineScribe. Transcripcion local y exportacion traducida para macOS.", back: "Volver arriba" }
  },
  fr: {
    meta: { title: "OfflineScribe - Transcription locale pour macOS", description: "OfflineScribe transcrit l'audio, relit les timelines, traduit le texte et exporte les resultats localement sur macOS." },
    ...
    footer: { copy: "OfflineScribe. Transcription locale et export traduit pour macOS.", back: "Retour en haut" }
  },
  it: {
    meta: { title: "OfflineScribe - Trascrizione locale per macOS", description: "OfflineScribe trascrive audio, rivede timeline, traduce testo ed esporta risultati localmente su macOS." },
    ...
    privacy: { eyebrow: "Informativa privacy", title: "Trascrizione e traduzione restano locali.", updated: "Ultimo aggiornamento: 1 settembre 2026", appTitle: "Privacy app", appText: "OfflineScribe non carica audio, testo o traduzioni. L'app usa Apple SpeechAnalyzer e Apple Translation sul tuo Mac.", modelsTitle: "Modelli di sistema", modelsText: "I modelli lingua e traduzione sono gestiti nelle Impostazioni di Sistema macOS. L'app verifica disponibilita ma non scarica modelli.", storeTitle: "Nessun acquisto in-app", storeText: "OfflineScribe e un download a pagamento su App Store. Tutte le funzioni sono incluse, senza acquisti in-app, abbonamenti, prove, ripristino acquisti o sblocchi nell'app.", siteTitle: "Privacy sito", siteText: "Questo sito statico non include analytics, tracker, moduli, cookie o font online. Cloudflare puo elaborare log standard come provider hosting." },
    pricing: { eyebrow: "Un solo acquisto", title: "Tutto incluso. Nessun abbonamento.", text: "L'App Store mostra il prezzo per il tuo paese o regione. Scarica una volta e usa tutte le funzioni di trascrizione, traduzione ed esportazione.", freeTitle: "App completa", freeText: "Sono inclusi trascrizione in batch, pausa e ripresa, traduzione locale, azioni Finder e tutti i formati di esportazione.", unlockTitle: "Download a pagamento", unlockText: "Nessun acquisto in-app, quota giornaliera, limite a pagamento per dimensione file, prova gratuita o abbonamento.", availableTitle: "Disponibile su App Store", availableText: "Scarica OfflineScribe per macOS 26 o versioni successive." },
    ...
    footer: { copy: "OfflineScribe. Trascrizione locale ed export tradotto per macOS.", back: "Torna su" }
  },
  ja: {
    meta: { title: "OfflineScribe - macOS向けローカル音声文字起こし", description: "OfflineScribeは音声を文字起こしし、タイムライン確認、翻訳、書き出しをmacOS上でローカルに行います。" },
    skip: "本文へ移動",
    language: { label: "言語" },
    ...
    features: { eyebrow: "基本ワークフロー", title: "音声キューから翻訳済み文字起こしへ。", text: "OfflineScribeはデスクトップの反復作業に向けて、キュー、一時停止、タイムライン確認、必要な形式への書き出しをまとめます。", batchTitle: "一括変換", batchText: "1つまたは複数の音声をドラッグし、認識言語を選び、キューを1件ずつ処理します。", pauseTitle: "一時停止と再開", pauseText: "長い文字起こしを一時停止し、別の項目を先に処理してから最後の確定セグメント付近で再開します。", timelineTitle: "タイムライン翻訳", timelineText: "原文を変更せず、表示中のセグメントを確認用に翻訳します。", exportTitle: "書き出し形式", exportText: "原文または翻訳済みの文字起こしをTXT、Markdown、HTML、DOCX、SRT、VTTで書き出せます。" },
    workflow: { eyebrow: "使い方", title: "丁寧な文字起こし作業のためのデスクトップフロー。", text: "OfflineScribeはキュー、言語、出力先、タイムライン、翻訳書き出しを1つのmacOSウィンドウにまとめます。", step1Label: "音声を追加", step1Text: "アプリにドラッグするか、Finderから対応音声を送ります。", step2Label: "確認", step2Text: "変換後にリアルタイムテキストとタイムラインセグメントを切り替えます。", step3Label: "書き出し", step3Text: "原文を再書き出しするか、字幕、メモ、文書用に翻訳ファイルを作成します。" },
    ...
    privacy: { eyebrow: "プライバシーポリシー", title: "文字起こしと翻訳はローカルに留まります。", updated: "最終更新: 2026年9月1日", appTitle: "アプリのプライバシー", appText: "OfflineScribeは音声、文字起こし、翻訳をアップロードしません。Apple SpeechAnalyzerとApple TranslationをMac上で使用します。", modelsTitle: "システムモデル", modelsText: "言語モデルと翻訳モデルはmacOSのシステム設定で管理されます。アプリは利用可否を確認しますが、モデルをダウンロードしません。", storeTitle: "アプリ内課金なし", storeText: "OfflineScribeはApp Storeの有料ダウンロードです。すべての機能が含まれ、アプリ内課金、サブスクリプション、無料トライアル、購入の復元、機能のアンロックはありません。", siteTitle: "Webサイトのプライバシー", siteText: "この静的サイトには分析スクリプト、広告トラッカー、フォーム、Cookie、オンラインフォントはありません。Cloudflareがホスティング提供者として標準的なリクエストログを処理する場合があります。" },
    pricing: { eyebrow: "一度だけ購入", title: "すべての機能を収録。サブスクリプションなし。", text: "価格は国または地域に応じてApp Storeに表示されます。一度ダウンロードすれば、文字起こし、翻訳、書き出しの全機能を利用できます。", freeTitle: "完全版アプリ", freeText: "一括文字起こし、一時停止と再開、ローカル翻訳、Finderアクション、すべての書き出し形式が含まれます。", unlockTitle: "有料ダウンロード", unlockText: "アプリ内課金、1日の上限、ファイルサイズによる課金制限、無料トライアル、サブスクリプションはありません。", availableTitle: "App Storeで配信中", availableText: "macOS 26以降対応のOfflineScribeをダウンロードできます。" },
    ...
    footer: { copy: "OfflineScribe。macOS向けローカル文字起こしと翻訳書き出し。", back: "上へ戻る" }
  },
  ko: {
    meta: { title: "OfflineScribe - macOS용 로컬 음성 전사", description: "OfflineScribe는 macOS에서 오디오 전사, 타임라인 검토, 번역, 내보내기를 로컬로 처리합니다." },
    skip: "본문으로 이동",
    language: { label: "언어" },
    ...
    privacy: { eyebrow: "개인정보 처리방침", title: "전사와 번역은 로컬에 남아 있습니다.", updated: "최종 업데이트: 2026년 9월 1일", appTitle: "앱 개인정보", appText: "OfflineScribe는 오디오, 전사 텍스트, 번역을 업로드하지 않습니다. Apple SpeechAnalyzer와 Apple Translation을 Mac에서 사용합니다.", modelsTitle: "시스템 모델", modelsText: "언어 및 번역 모델은 macOS 시스템 설정에서 관리됩니다. 앱은 사용 가능 여부만 확인하며 모델을 다운로드하지 않습니다.", storeTitle: "앱 내 구입 없음", storeText: "OfflineScribe는 App Store 유료 다운로드 앱입니다. 모든 기능이 포함되며 앱 내 구입, 구독, 무료 체험, 구입 복원 또는 기능 잠금 해제가 없습니다.", siteTitle: "웹사이트 개인정보", siteText: "이 정적 사이트에는 분석 스크립트, 광고 추적기, 양식, 쿠키, 온라인 폰트가 없습니다. Cloudflare는 호스팅 제공자로서 표준 요청 로그를 처리할 수 있습니다." },
    pricing: { eyebrow: "한 번만 구입", title: "모든 기능 포함. 구독 없음.", text: "App Store가 국가 또는 지역에 맞는 가격을 표시합니다. 한 번 다운로드하고 모든 전사, 번역 및 내보내기 기능을 사용하세요.", freeTitle: "완전한 앱", freeText: "일괄 전사, 일시 정지 및 계속, 로컬 번역, Finder 동작과 모든 내보내기 형식이 포함됩니다.", unlockTitle: "유료 다운로드", unlockText: "앱 내 구입, 일일 할당량, 파일 크기 유료 제한, 무료 체험 또는 구독이 없습니다.", availableTitle: "App Store에서 이용 가능", availableText: "macOS 26 이상용 OfflineScribe를 다운로드하세요." },
    ...
    footer: { copy: "OfflineScribe. macOS용 로컬 전사와 번역 내보내기.", back: "맨 위로" }
  },
  "pt-BR": {
    meta: { title: "OfflineScribe - Transcricao local para macOS", description: "OfflineScribe transcreve audio, revisa linhas do tempo, traduz texto e exporta resultados localmente no macOS." },
    ...
    footer: { copy: "OfflineScribe. Transcricao local e exportacao traduzida para macOS.", back: "Voltar ao topo" }
  },
  "zh-Hans": {
    meta: { title: "OfflineScribe - macOS 本机语音转文字", description: "OfflineScribe 在 macOS 本机完成音频转写、时间轴审阅、文本翻译和译文导出。" },
    skip: "跳转到正文",
    language: { label: "语言" },
    ...
    features: { eyebrow: "核心工作流", title: "从音频队列到译文转写稿。", text: "OfflineScribe 面向重复的桌面转写工作：排队文件、暂停长任务、审阅时间轴，然后导出到下一个工具需要的格式。", batchTitle: "批量转换", batchText: "拖入一个或多个音频文件，选择识别语言，并按队列逐个处理。", pauseTitle: "暂停与续跑", pauseText: "暂停长音频转写，先处理其他项目，再从最后完成的片段附近继续。", timelineTitle: "时间轴翻译", timelineText: "为审阅翻译当前可见片段，不改写原始转写文本。", exportTitle: "多格式导出", exportText: "将原文或译文导出为 TXT、Markdown、HTML、DOCX、SRT 或 VTT。" },
    workflow: { eyebrow: "使用方式", title: "为认真审阅转写稿设计的桌面流程。", text: "OfflineScribe 将转换队列、语言选择、输出目录、时间轴和译文导出放在一个安静的 macOS 窗口里。", step1Label: "加入音频", step1Text: "在应用内添加、拖入队列，或从 Finder 发送支持的音频。", step2Label: "审阅时间轴", step2Text: "转换完成后，在实时文本和时间轴片段之间切换。", step3Label: "导出", step3Text: "重新导出原文，或创建用于字幕、笔记和文档的译文文件。" },
    ...
    privacy: { eyebrow: "隐私政策", title: "转写和翻译都留在本机。", updated: "最后更新：2026 年 9 月 1 日", appTitle: "应用隐私", appText: "OfflineScribe 不上传你的音频、转写文本或译文。应用围绕在 Mac 上运行的 Apple SpeechAnalyzer 和 Apple Translation 框架设计。", modelsTitle: "系统模型", modelsText: "语言和翻译模型由 macOS 系统设置管理。应用会检查模型是否可用，但不会自行下载模型。", storeTitle: "无 App 内购买", storeText: "OfflineScribe 是 App Store 一次性付费下载应用。所有功能均已包含，应用内没有购买项目、订阅、试用、恢复购买或功能解锁。", siteTitle: "网站隐私", siteText: "这个静态网站不包含分析脚本、广告跟踪器、表单、Cookie 或在线字体。Cloudflare 作为托管提供商可能会处理标准请求日志。" },
    pricing: { eyebrow: "一次购买", title: "全部功能，无需订阅。", text: "价格由 App Store 根据你的国家或地区显示。下载一次，即可使用全部转写、翻译和导出功能。", freeTitle: "完整应用", freeText: "批量转写、暂停与继续、本机翻译、Finder 操作和全部导出格式均已包含。", unlockTitle: "付费下载", unlockText: "没有 App 内购买、每日额度、文件大小付费限制、免费试用或订阅。", availableTitle: "已在 App Store 上架", availableText: "下载适用于 macOS 26 或更高版本的 OfflineScribe。" },
    ...
    footer: { copy: "OfflineScribe。面向 macOS 的本机转写与译文导出。", back: "返回顶部" }
  },
  "zh-Hant": {
    meta: { title: "OfflineScribe - macOS 本機語音轉文字", description: "OfflineScribe 在 macOS 本機完成音訊轉寫、時間軸審閱、文字翻譯和譯文匯出。" },
    skip: "跳至內容",
    language: { label: "語言" },
    ...
    features: { eyebrow: "核心工作流程", title: "從音訊佇列到譯文轉寫稿。", text: "OfflineScribe 面向重複的桌面轉寫工作：排入檔案、暫停長任務、審閱時間軸，然後匯出到下一個工具需要的格式。", batchTitle: "批次轉換", batchText: "拖入一個或多個音訊檔案，選擇辨識語言，並按佇列逐個處理。", pauseTitle: "暫停與續跑", pauseText: "暫停長音訊轉寫，先處理其他項目，再從最後完成的片段附近繼續。", timelineTitle: "時間軸翻譯", timelineText: "為審閱翻譯目前可見片段，不改寫原始轉寫文字。", exportTitle: "多格式匯出", exportText: "將原文或譯文匯出為 TXT、Markdown、HTML、DOCX、SRT 或 VTT。" },
    workflow: { eyebrow: "使用方式", title: "為認真審閱轉寫稿設計的桌面流程。", text: "OfflineScribe 將轉換佇列、語言選擇、輸出目錄、時間軸和譯文匯出放在一個安靜的 macOS 視窗裡。", step1Label: "加入音訊", step1Text: "在 App 內加入、拖入佇列，或從 Finder 傳送支援的音訊。", step2Label: "審閱時間軸", step2Text: "轉換完成後，在即時文字和時間軸片段之間切換。", step3Label: "匯出", step3Text: "重新匯出原文，或建立用於字幕、筆記和文件的譯文檔案。" },
    ...
    privacy: { eyebrow: "隱私政策", title: "轉寫和翻譯都留在本機。", updated: "最後更新：2026 年 9 月 1 日", appTitle: "App 隱私", appText: "OfflineScribe 不上傳你的音訊、轉寫文字或譯文。App 圍繞在 Mac 上執行的 Apple SpeechAnalyzer 和 Apple Translation 框架設計。", modelsTitle: "系統模型", modelsText: "語言和翻譯模型由 macOS 系統設定管理。App 會檢查模型是否可用，但不會自行下載模型。", storeTitle: "無 App 內購買", storeText: "OfflineScribe 是 App Store 一次性付費下載 App。所有功能均已包含，App 內沒有購買項目、訂閱、試用、恢復購買或功能解鎖。", siteTitle: "網站隱私", siteText: "這個靜態網站不包含分析腳本、廣告追蹤器、表單、Cookie 或線上字體。Cloudflare 作為託管提供商可能會處理標準請求日誌。" },
    pricing: { eyebrow: "一次購買", title: "全部功能，無需訂閱。", text: "價格由 App Store 根據你的國家或地區顯示。下載一次，即可使用全部轉寫、翻譯和匯出功能。", freeTitle: "完整 App", freeText: "批次轉寫、暫停與繼續、本機翻譯、Finder 操作和全部匯出格式均已包含。", unlockTitle: "付費下載", unlockText: "沒有 App 內購買、每日額度、檔案大小付費限制、免費試用或訂閱。", availableTitle: "已在 App Store 上架", availableText: "下載適用於 macOS 26 或以上版本的 OfflineScribe。" },
...
const reviewCopy = {
  ...
  "zh-Hans": ["1.2 版本预览", "回听、校正，再导出。", "点击句子跳转，调整播放速度，编辑原文或译文，并可撤销修改。修订保存在本机，下次启动时恢复。", "OfflineScribe 校对工作台，显示真实英语转写结果", "来自 1.2 开发构建的真实界面，使用 LibriVox 的《The Importance of Being Earnest》录音。识别结果仍需校对；单个案例不代表准确率。", "视频与字幕", "导入 MP4 或 MOV，选择音轨并同步预览字幕。支持分割、合并、时间调整，以及原文、译文或双语 SRT/VTT 导出，可选择上下行顺序。", "开始前请准备", "需要 macOS 26+，并在系统设置中安装所需语音和翻译模型。MP4/MOV 支持取决于 macOS 可解码的编码；受保护或没有音轨的视频无法转写。"],
  "zh-Hant": ["1.2 版本預覽", "回聽、校正，再匯出。", "點選句子跳轉，調整播放速度，編輯原文或譯文，並可復原修改。修訂儲存在本機，下次啟動時恢復。", "OfflineScribe 校對工作台，顯示真實英語轉寫結果", "來自 1.2 開發版本的真實介面，使用 LibriVox 的《The Importance of Being Earnest》錄音。辨識結果仍需校對；單一案例不代表準確率。", "影片與字幕", "匯入 MP4 或 MOV，選擇音軌並同步預覽字幕。支援分割、合併、時間調整，以及原文、譯文或雙語 SRT/VTT 匯出，可選擇上下行順序。", "開始前請準備", "需要 macOS 26+，並在系統設定中安裝所需語音和翻譯模型。MP4/MOV 支援取決於 macOS 可解碼的編碼；受保護或沒有音軌的影片無法轉寫。"]
};
...
const SCREENSHOT_FILES = [
  "01-audio-video-to-text.webp",
  "02-review-and-seek.webp",
  "03-bilingual-subtitles.webp",
  "04-private-on-mac.webp",
  "05-batch-pause-resume.webp",
  "06-export-formats.webp"
];

const SCREENSHOT_ALTS = {
  "en-US": ["Turn audio and video into editable text. Everything stays on your Mac; no media or text uploads.", "Listen, edit, and click any sentence to seek. Playback, search, split, merge, undo, and redo in one workspace.", "Preview original, translated, and bilingual subtitles. Adjust timing, then export SRT or VTT.", "Sensitive content stays on your Mac. No cloud transcription, accounts, or remote logging.", "Batch long files with pause and resume. Pause, run another task, then continue nearby.", "Proof once and export six formats: TXT, Markdown, HTML, DOCX, SRT, and VTT."],
  de: ["Audio und Video in bearbeitbaren Text verwandeln. Alles bleibt auf dem Mac – keine Medien- oder Textuploads.", "Anhören, korrigieren und per Satz springen. Wiedergabe, Suche, Teilen, Verbinden, Rückgängig und Wiederholen.", "Original, Übersetzung und zweisprachige Untertitel. Timing anpassen und als SRT oder VTT exportieren.", "Vertrauliche Inhalte bleiben auf deinem Mac. Keine Cloud-Transkription, Konten oder Remote-Protokolle.", "Stapelverarbeitung mit Pause und Fortsetzen. Andere Aufgaben vorziehen und anschließend in der Nähe fortfahren.", "Einmal prüfen, sechs Formate exportieren: TXT, Markdown, HTML, DOCX, SRT und VTT."],
  "es-ES": ["Convierte audio y vídeo en texto editable. Todo se procesa en el Mac, sin subir audio, vídeo ni texto.", "Escucha, edita y pulsa una frase para ir a ella. Reproduce, busca, divide, une, deshaz y rehace.", "Previsualiza original, traducción y subtítulos bilingües. Ajusta los tiempos y exporta en SRT o VTT.", "El contenido sensible se queda en tu Mac. Sin transcripción en la nube, cuentas ni registros remotos.", "Procesa por lotes con pausa y reanudación. Prioriza otra tarea y continúa desde un punto cercano.", "Revisa una vez y exporta en seis formatos: TXT, Markdown, HTML, DOCX, SRT y VTT."],
  "es-MX": ["Convierte audio y vídeo en texto editable. Todo se procesa en el Mac, sin subir audio, vídeo ni texto.", "Escucha, edita y pulsa una frase para ir a ella. Reproduce, busca, divide, une, deshaz y rehace.", "Previsualiza original, traducción y subtítulos bilingües. Ajusta los tiempos y exporta en SRT o VTT.", "El contenido sensible se queda en tu Mac. Sin transcripción en la nube, cuentas ni registros remotos.", "Procesa por lotes con pausa y reanudación. Prioriza otra tarea y continúa desde un punto cercano.", "Revisa una vez y exporta en seis formatos: TXT, Markdown, HTML, DOCX, SRT y VTT."],
  fr: ["Transformez l’audio et la vidéo en texte modifiable. Tout reste sur votre Mac, sans envoi de média ni de texte.", "Écoutez, corrigez et cliquez sur une phrase. Lecture, recherche, découpe, fusion, annulation et rétablissement.", "Prévisualisez l’original, la traduction et le bilingue. Ajustez le minutage, puis exportez en SRT ou VTT.", "Vos contenus sensibles restent sur votre Mac. Sans transcription cloud, compte ni journalisation distante.", "Traitez par lot, avec pause et reprise. Passez à une autre tâche, puis reprenez au bon endroit.", "Une relecture, six formats d’export : TXT, Markdown, HTML, DOCX, SRT et VTT."],
  "fr-CA": ["Transformez l’audio et la vidéo en texte modifiable. Tout reste sur votre Mac, sans envoi de média ni de texte.", "Écoutez, corrigez et cliquez sur une phrase. Lecture, recherche, découpe, fusion, annulation et rétablissement.", "Prévisualisez l’original, la traduction et le bilingue. Ajustez le minutage, puis exportez en SRT ou VTT.", "Vos contenus sensibles restent sur votre Mac. Sans transcription cloud, compte ni journalisation distante.", "Traitez par lot, avec pause et reprise. Passez à une autre tâche, puis reprenez au bon endroit.", "Une relecture, six formats d’export : TXT, Markdown, HTML, DOCX, SRT et VTT."],
  it: ["Trasforma audio e video in testo modificabile. Tutto avviene sul Mac, senza caricare file multimediali o testo.", "Ascolta, modifica e fai clic su una frase. Riproduci, cerca, dividi, unisci, annulla e ripeti.", "Anteprima di originale, traduzione e sottotitoli bilingue. Regola i tempi ed esporta in SRT o VTT.", "I contenuti sensibili restano sul tuo Mac. Nessuna trascrizione cloud, account o registro remoto.", "Elaborazione in serie con pausa e ripresa. Dai priorità a un’altra attività e poi riprendi da lì vicino.", "Una revisione, sei formati di esportazione: TXT, Markdown, HTML, DOCX, SRT e VTT."],
  ja: ["音声・動画を編集できるテキストに。メディアも文字もアップロードせず、すべて Mac 上で処理します。", "聞きながら編集し、文をクリックして移動。再生、検索、分割、結合、取り消し、やり直しを一か所で。", "原文・訳文・二言語字幕を同時プレビュー。タイミングを調整し、SRT または VTT で書き出せます。", "機密コンテンツは Mac の中だけに。クラウド文字起こし、アカウント、リモートログはありません。", "一括処理も一時停止して再開。別のタスクを優先し、近い位置から続けられます。", "一度校正して 6 形式で書き出し：TXT、Markdown、HTML、DOCX、SRT、VTT。"],
  ko: ["오디오와 비디오를 편집 가능한 텍스트로. Mac에서만 처리되어 미디어와 텍스트를 업로드하지 않습니다.", "들으며 수정하고 문장을 눌러 바로 이동. 재생, 검색, 분할, 병합, 실행 취소와 다시 실행을 한곳에서.", "원문·번역·이중 언어 자막을 한눈에. 타이밍을 조정하고 SRT 또는 VTT로 내보내세요.", "민감한 콘텐츠는 Mac 안에 그대로. 클라우드 전사, 계정, 원격 로그가 없습니다.", "일괄 처리도 일시 정지하고 이어서. 다른 작업을 먼저 처리한 뒤 가까운 지점에서 계속하세요.", "한 번 교정하고 6가지 형식으로 내보내기: TXT, Markdown, HTML, DOCX, SRT, VTT."],
  "pt-BR": ["Transforme áudio e vídeo em texto editável. Tudo é processado no Mac, sem enviar mídia ou texto.", "Ouça, edite e clique numa frase para avançar. Reprodução, busca, divisão, união, desfazer e refazer.", "Veja original, tradução e legendas bilíngues. Ajuste os tempos e exporte em SRT ou VTT.", "Conteúdo sensível fica sempre no seu Mac. Sem transcrição na nuvem, contas ou logs remotos.", "Processe em lote com pausa e retomada. Priorize outra tarefa e depois continue de onde parou.", "Revise uma vez e exporte em seis formatos: TXT, Markdown, HTML, DOCX, SRT e VTT."],
  "pt-PT": ["Transforme áudio e vídeo em texto editável. Tudo é processado no Mac, sem enviar mídia ou texto.", "Ouça, edite e clique numa frase para avançar. Reprodução, busca, divisão, união, desfazer e refazer.", "Veja original, tradução e legendas bilíngues. Ajuste os tempos e exporte em SRT ou VTT.", "Conteúdo sensível fica sempre no seu Mac. Sem transcrição na nuvem, contas ou logs remotos.", "Processe em lote com pausa e retomada. Priorize outra tarefa e depois continue de onde parou.", "Revise uma vez e exporte em seis formatos: TXT, Markdown, HTML, DOCX, SRT e VTT."],
  "zh-Hans": ["音频视频，转成可编辑文字。全程在 Mac 本机处理，媒体和文字无需上传。", "边听边改，点击一句即可跳转。播放、搜索、拆分合并、撤销重做，一处完成。", "原文、译文、双语字幕同步预览。调整时间轴，导出 SRT 或 VTT。", "敏感内容始终留在你的 Mac。无云端转写、无账号、无远程日志。", "批量处理，长任务也能暂停续跑。暂停后先处理其他任务，再从附近继续。", "一次校对，六种格式直接导出：TXT、Markdown、HTML、DOCX、SRT、VTT。"],
  "zh-Hant": ["音訊影片，轉成可編輯文字。全程在 Mac 本機處理，媒體和文字無需上傳。", "邊聽邊改，點選一句即可跳轉。播放、搜尋、分割合併、復原重做，一處完成。", "原文、譯文、雙語字幕同步預覽。調整時間軸，匯出 SRT 或 VTT。", "敏感內容始終留在你的 Mac。無雲端轉寫、無帳號、無遠端記錄。", "批次處理，長任務也能暫停續跑。暫停後先處理其他任務，再從附近繼續。", "一次校對，六種格式直接匯出：TXT、Markdown、HTML、DOCX、SRT、VTT。"]
};

const LATEST_LABELS = {
  "en-US": ["Add media", "Supported media", "Last updated: September 6, 2026"],
  de: ["Medien hinzufügen", "Unterstützte Medien", "Zuletzt aktualisiert: 6. September 2026"],
  "es-ES": ["Añadir archivos", "Archivos compatibles", "Última actualización: 6 de septiembre de 2026"],
  "es-MX": ["Agregar archivos", "Archivos compatibles", "Última actualización: 6 de septiembre de 2026"],
  fr: ["Ajouter des médias", "Médias compatibles", "Dernière mise à jour : 6 septembre 2026"],
  "fr-CA": ["Ajouter des médias", "Médias compatibles", "Dernière mise à jour : 6 septembre 2026"],
  it: ["Aggiungi media", "Media supportati", "Ultimo aggiornamento: 6 settembre 2026"],
  ja: ["メディアを追加", "対応メディア", "最終更新：2026年9月6日"],
  ko: ["미디어 추가", "지원 미디어", "마지막 업데이트: 2026년 9월 6일"],
  "pt-BR": ["Adicionar mídia", "Mídia compatível", "Última atualização: 6 de setembro de 2026"],
  "pt-PT": ["Adicionar multimédia", "Multimédia compatível", "Última atualização: 6 de setembro de 2026"],
  "zh-Hans": ["加入媒体", "支持的媒体", "最后更新：2026 年 9 月 6 日"],
  "zh-Hant": ["加入媒體", "支援的媒體", "最後更新：2026 年 9 月 6 日"]
};
...
function applyLocale(locale) {
  ...
  const screenshotLocale = SCREENSHOT_LOCALE[normalized] || SCREENSHOT_LOCALE[DEFAULT_LOCALE];
  const screenshotCopy = SCREENSHOT_ALTS[screenshotLocale] || SCREENSHOT_ALTS["en-US"];
  const latestLabels = LATEST_LABELS[screenshotLocale] || LATEST_LABELS["en-US"];

  dictionary.hero.lead = `${screenshotCopy[0]} ${screenshotCopy[2]}`;
  dictionary.features.text = `${screenshotCopy[1]} ${screenshotCopy[4]}`;
  dictionary.features.batchText = screenshotCopy[4];
  dictionary.features.exportText = screenshotCopy[5];
  dictionary.workflow.step1Label = latestLabels[0];
  dictionary.workflow.step1Text = screenshotCopy[0];
  dictionary.formats.inputTitle = latestLabels[1];
  dictionary.formats.text = `${screenshotCopy[2]} ${screenshotCopy[5]}`;
  dictionary.privacy.updated = latestLabels[2];
  dictionary.privacy.appText = screenshotCopy[3];
  dictionary.pricing.freeText = `${screenshotCopy[4]} ${screenshotCopy[5]}`;
  dictionary.footer.copy = `OfflineScribe. ${screenshotCopy[0]}`;
  ...
  for (const image of document.querySelectorAll("[data-screenshot]")) {
    const index = Number(image.dataset.screenshot);
    const filename = SCREENSHOT_FILES[index];
    if (!filename) continue;
    image.src = `assets/marketing/1.2/${screenshotLocale}/${filename}`;
    image.alt = SCREENSHOT_ALTS[screenshotLocale]?.[index] || SCREENSHOT_ALTS["en-US"][index];
  }
  for (const link of document.querySelectorAll("[data-screenshot-link]")) {
    const index = Number(link.dataset.screenshotLink);
    const filename = SCREENSHOT_FILES[index];
    if (!filename) continue;
    link.href = `assets/marketing/1.2/${screenshotLocale}/${filename}`;
    link.setAttribute("aria-label", SCREENSHOT_ALTS[screenshotLocale]?.[index] || SCREENSHOT_ALTS["en-US"][index]);
  }
  const screenshotGrid = document.querySelector(".screenshot-grid");
  if (screenshotGrid) screenshotGrid.setAttribute("aria-label", dictionary.review?.title || "OfflineScribe 1.2");
